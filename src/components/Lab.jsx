  ...
  return (
    <section className="lab" id="lab">
      <div className="wrap lab-head">
        ...
        <p>Drag through the material system. Every layer is accessible, replaceable and designed for a decade—not a launch cycle.</p>
      </div>
      ...
      <div className="wrap swipe-hint mono">Swipe to explore →</div>
    </section>
  );
}
