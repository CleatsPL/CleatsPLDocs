  ...
  return (
    <section className="quiet" id="quiet">
      <div className="quiet-stage">
        ...
        <div className="quiet-badge mono">Accelerating or braking. Never drifting.</div>
        <div className="quiet-head">
          <div className="section-tag mono">03 / Velocity profile</div>
